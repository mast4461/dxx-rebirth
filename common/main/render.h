...
//draws the world into the provided canvas
void render_frame(grs_canvas &, fix eye_offset, window_rendered_data &);

//draws the world into the provided canvas with a wideangle projection
void render_wideangle_frame(grs_canvas &, fix eye_offset, window_rendered_data &);

//draws the world into the provided canvas with the given orientation offset (rx, ry and rz)
void render_subframe(grs_canvas &, fix eye_offset, window_rendered_data &, int rx, int ry, int rz);
